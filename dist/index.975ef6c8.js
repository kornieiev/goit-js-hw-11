...
parcelHelpers.export(exports, "btnLeadMoreEl", ()=>btnLeadMoreEl);
...
var _markup = require("./markup/markup");
const searchForm = document.querySelector("#search-form");
const galleryBox = document.querySelector(".gallery");
const btnLeadMoreEl = document.querySelector(".load-more");
let currentPage = 1;
let lastPage = 0;
...
async function onFormSubmit(event) {
    ...
    const inputValue1 = formData.get("searchQuery").trim();
    if (inputValue1 !== "") {
        const arrayPhotos = await (0, _api.loadAll)(inputValue1, currentPage);
        galleryBox.innerHTML = (0, _markup.makeMarkup)(arrayPhotos);
        ...
        } else (0, _notiflixDefault.default).Notify.success(`Hooray! We found ${arrayPhotos.data.totalHits} images.`);
        currentPage = 1;
        if (currentPage === lastPage || lastPage === 0) btnLeadMoreEl.classList.add("hidden");
        else btnLeadMoreEl.classList.remove("hidden");
    }
...
async function loadMore() {
    const formData = new FormData(searchForm);
    const inputValue2 = formData.get("searchQuery").trim();
    const morePhotos = await (0, _api.loadAll)(inputValue2, currentPage + 1);
    currentPage = morePhotos.config.params.page;
    galleryBox.innerHTML = galleryBox.innerHTML + (0, _markup.makeMarkup)(morePhotos);
    new (0, _simplelightboxDefault.default)(".gallery a", {
        captionDelay: 250
    });
    const { height: cardHeight  } = document.querySelector(".gallery").firstElementChild.getBoundingClientRect();
...
},{"./api/api":"1nO8u","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","notiflix":"5z0Oc","simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","./markup/markup":"jsMS9"}],"1nO8u":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
async function loadAll(inputValue, page) {
    try {
...
},{}],"kaxSc":[function() {},{}],"jsMS9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "makeMarkup", ()=>makeMarkup);
function makeMarkup(arrayPhotos) {
